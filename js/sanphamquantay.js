...
function filterProductsByCategory(products) {
  return products.filter(product => 
    (product.name && (
      product.name.toLowerCase().includes("quần tây") || 
      product.name.toLowerCase().includes("quan tay") || 
      product.name.toLowerCase().includes("tây")
    )) ||
    (product.category && (
      product.category.toLowerCase().includes("quần tây") || 
      product.category.toLowerCase().includes("quan tay") || 
      product.category.toLowerCase().includes("tây")
    ))
  );
}
