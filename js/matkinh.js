...
function filterProductsByCategory(products) {
  return products.filter(product => 
    (product.name && (
      ...
      product.name.toLowerCase().includes("mat khinh") || 
      product.name.toLowerCase().includes("kinh")
    )) ||
    (product.category && (
      product.category.toLowerCase().includes("mắt kính") || 
      product.category.toLowerCase().includes("kinh") || 
      product.category.toLowerCase().includes("mat khinh")
    ))
  );
}
