...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function populateProvinces() {
    fetch("https://provinces.open-api.vn/api/p/")
      ...
      .catch(error => console.error("Lỗi tải danh sách tỉnh/thành:", error));
  }
  ...
  function populateDistricts(provinceCode) {
    ...
    if (provinceCode) {
      fetch(`https://provinces.open-api.vn/api/p/${provinceCode}?depth=2`)
        ...
        .catch(error => console.error("Lỗi tải danh sách quận/huyện:", error));
    }
  }
  ...
  function populateWards(districtCode) {
    ...
    if (districtCode) {
      fetch(`https://provinces.open-api.vn/api/d/${districtCode}?depth=2`)
        ...
        .catch(error => console.error("Lỗi tải danh sách phường/xã:", error));
    }
  }

  // Gọi hàm để khởi tạo danh sách tỉnh/thành phố
  populateProvinces();
