...
function filterProductsByCategory(products) {
  return products.filter(product => 
    (product.name && (
      product.name.toLowerCase().includes("quần kaki") || 
      product.name.toLowerCase().includes("quan kaki") || 
      product.name.toLowerCase().includes("kaki")
    )) ||
    (product.category && (
      product.category.toLowerCase().includes("quần kaki") || 
      product.category.toLowerCase().includes("quan kaki") || 
      product.category.toLowerCase().includes("kaki")
    ))
  );
}
