...
function filterProductsByCategory(products) {
  return products.filter(product => 
    (product.name && (
      ...
      product.name.toLowerCase().includes("non") || 
      product.name.toLowerCase().includes("cái nón")
    )) ||
    (product.category && (
      product.category.toLowerCase().includes("nón") || 
      product.category.toLowerCase().includes("non") || 
      product.category.toLowerCase().includes("cái nón")
    ))
  );
}
